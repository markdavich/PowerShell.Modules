...
function Save-UserSettings {
    ...
    Write-Host "User.Setup.Settings: Save-UserSettings for user '$username'" -ForegroundColor Cyan
...
function Get-UserSettings {
    ...
    # Write-Host "User.Setup.Settings: Get-UserSettings" -ForegroundColor Green -BackgroundColor Yellow -NoNewline; Write-Host "" -ForegroundColor White -BackgroundColor Black
...
function Initialize-UserProfile {
    ...
    # Write-Host "User.Setup.Settings: Initialize-UserProfile" -ForegroundColor Green -BackgroundColor Yellow -NoNewline; Write-Host "" -ForegroundColor White -BackgroundColor Black
    # Write-Host "    `$username: '$username'" -ForegroundColor Green
...
function Initialize-DefaultProfile {
    # Write-Host "User.Setup.Settings: Initialize-DefaultProfile" -ForegroundColor Green -BackgroundColor Yellow -NoNewline; Write-Host "" -ForegroundColor White -BackgroundColor Black
